<html>
    ...
    <body>
       ...
       <p>
        ...
        <p>
            Sign CA: <a href="{{CA_HTML_SIGN_NAME}}.crt">Show</a> (<a href="{{CA_HTML_SIGN_NAME}}.crt" download>Download</a>)<br>
            SHA1 fingerprint: {{CA_HTML_SIGN_HASH}}<br>
            Valid until: {{CA_HTML_SIGN_VALID_UNTIL}}
        </p>

        <p>
            Chain PEM: <a href="{{CA_HTML_SIGN_NAME}}.chain.pem">Show</a> (<a href="{{CA_HTML_SIGN_NAME}}.chain.pem" download>Download</a>)
        </p>

        <p>
            Revocation list: <a href="{{CA_HTML_SIGN_NAME}}.crl">Show</a> (<a href="{{CA_HTML_SIGN_NAME}}.crl" download>Download</a>)<br>
            Revoked certificates: {{CA_HTML_SIGN_REVOKED}}
        </p>
